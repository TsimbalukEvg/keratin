...
document.addEventListener('DOMContentLoaded', () => {
    ...
    optionButtons.forEach(button => {
        button.addEventListener('click', (e) => {
            ...
            // Затримка для завершення анімації (400 мс, як у CSS)
            setTimeout(() => {
                ...
                // Знімаємо клас 'selected' після переходу, щоб "очистити" вигляд кнопки, якщо повернемося
